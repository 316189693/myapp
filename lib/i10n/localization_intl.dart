...
class GmLocalizations{
  ...
  String get title {
    return Intl.message(
      'Code Will',
      name: 'title',
      desc: 'Title for the Code Will application',
    );
  }

  String get home => Intl.message('Code Will', name: 'home');
  ...
  String get notAnyMore => Intl.message('Not any More', name: 'notAnyMore');
}
